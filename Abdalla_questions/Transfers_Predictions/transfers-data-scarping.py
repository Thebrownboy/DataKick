...
teams=[]
                                                    #results{seasson_date}121_overall > tbody > tr:nth-child(1) > td:nth-child(2) > a
                                                    #results2021-2022121_overall > tbody > tr:nth-child(1) > td:nth-child(2) > a
                                                    #results2021-2022121_overall > tbody > tr:nth-child(2) > td:nth-child(2) > a
                                                    #results2021-2022121_overall > tbody > tr:nth-child(3) > td:nth-child(2) > a
                                                    #results2021-202291_overall > tbody > tr:nth-child(1) > td:nth-child(2) > a

                                                    #results2015-2016121_overall > tbody > tr:nth-child(1) > td:nth-child(2) > a
                                                    #results2015-2016121_overall > tbody > tr:nth-child(3) > td:nth-child(2)
                                                    #results2008-200991_overall>tbody>tr> .left>a
                                                    #results2015-2016121_overall > tbody > tr:nth-child(1) > td:nth-child(2) > a
                                                    #results2021-202291_overall > tbody > tr:nth-child(1) > td:nth-child(2) > a
...
with open (f"sstand-stats{seasson_date}/season-{seasson_date}","wb") as fp :
...
for i,name in   zip(teams_href,teams_names) :
    ...
    time.sleep(2)
    if has_conent:
        with open(f"sstand-stats{seasson_date}/{name}-stand-stats.csv","w") as file : 
            file.write(content)
